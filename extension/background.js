...
async function analyzeMatch(job, resumeText, apiKey) {
  ...
  const SYSTEM = [
    ...
    '',
    '【候选人画像锚定】候选人≈7年互联网生态增长经验，核心战场：创作者生态 / 直播 / 内容社区 / 达人 / MCN；强项：用户增长(发现页社区/拉新/用户分层)、数据分析(SQL/漏斗)、创作者与主播分层运营、内容社区商业化转化；弱项：裂变活动、渠道投放、纯用户增长策略owner。评估以简历原文真实证据为准，不凭标题臆断。',
    '',
    '【赛道识别规则】若JD出现"内容运营/分区运营/创作者/社区/UP主/直播/达人/MCN/生态"等词，即便岗位标题含"AI"，也应识别为"内容生态/创作者社区"赛道——与候选人强项高度契合，核心要求维度须据此给分，不得因标题含AI就误判为"AI工具/开发者生态"而压低；仅当JD实质职责确为AI工具研发/算法/工程时，才算开发者赛道。',
    '',
